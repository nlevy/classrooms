...
internal class StudentCsvParserTest {
    ...
    fun parseCsv() {
        ...
        assertEquals(1, ringo.clusterId)
        ...
        assertEquals(1, george.clusterId)
    ...
    fun writeToCsv() {
        val classes: Map<Int, List<Student>> = mapOf(
            (1 to listOf(
                ...
                Student(2, Gender.MALE, Grade.LOW, Grade.MEDIUM, 2, listOf(1), emptyList(), "bill", "school1", "bla")
            )),
            (2 to listOf(
                Student(3, Gender.MALE, Grade.LOW, Grade.MEDIUM, 1, listOf(4), listOf(1), "bob", "school2", "bla bla"),
                Student(4, Gender.MALE, Grade.LOW, Grade.MEDIUM, 0, listOf(3), emptyList(), "jenny", "school2", "bla")
            )),
        )
        ...
        val expectedCsv = """
classroom,name,school,gender,academicPerformance,behavioralPerformance,friend1,friend2,friend3,friend4,clusterId,notWith,comments
1,joe,school1,MALE,LOW,MEDIUM,bill,,,,1,,bla
1,bill,school1,MALE,LOW,MEDIUM,joe,,,,2,,bla
2,bob,school2,MALE,LOW,MEDIUM,jenny,,,,1,joe,"bla bla"
2,jenny,school2,MALE,LOW,MEDIUM,bob,,,,0,,bla""".trimIndent()
